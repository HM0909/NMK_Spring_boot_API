...
public class BoardService {
	 ...
	 * @return
	 */
	public Map<String, Object> registBoard(Board board_nmk) {
		 Map<String, Object> resultMap = new HashMap<String, Object>();
		 Map<String, Object> paramMap = new HashMap<String, Object>();
         
		 try {
	         paramMap.put("title", board_nmk.getTitle());
	         paramMap.put("readCount", board_nmk.getReadCount());
	         paramMap.put("linkUrl", board_nmk.getLinkUrl());
	         paramMap.put("attachUrl", board_nmk.getAttachUrl());
	         paramMap.put("writer", board_nmk.getWriter());
	         paramMap.put("content", board_nmk.getContent());
	 ...
	 * @return
	 */
	public Map<String, Object> modifyBoard(Board board_nmk) {
		 Map<String, Object> resultMap = new HashMap<String, Object>();
		 Map<String, Object> paramMap = new HashMap<String, Object>();
        
		 try {
			paramMap.put("seq", board_nmk.getSeq());
	        paramMap.put("title", board_nmk.getTitle());
	        paramMap.put("readCount", board_nmk.getReadCount());
	        paramMap.put("linkUrl", board_nmk.getLinkUrl());
	        paramMap.put("attachUrl", board_nmk.getAttachUrl());
